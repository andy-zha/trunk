...
static const NS_CONFIG::CfgInfo g_stCfgInfo[] = {
	//Processor
	{NS_CONFIG::EM_CFGID_SERVER_IP, "../etc/Ws.json", {"PROCESSOR", "SERVER_IP", (const char *)0}},
	{NS_CONFIG::EM_CFGID_SERVER_PORT, "../etc/Ws.json", {"PROCESSOR", "SERVER_PORT", (const char *)0}}
};
